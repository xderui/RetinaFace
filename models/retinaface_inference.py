...
from models.net import PPLCNet_x0_25
...
class RetinaFace(nn.Module):
    ...
    def forward(self,inputs):
        ...
        resize = 1
        im_height = inputs.shape[2]
        im_width = inputs.shape[3]
        device = torch.device("cpu")
        scale = torch.Tensor([inputs.shape[3], inputs.shape[2], inputs.shape[3], inputs.shape[2]])
