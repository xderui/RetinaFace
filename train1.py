...
from data.ufdd_face import ufddface
...
parser.add_argument('--training_dataset', default='./data/UFDD/UFDD_val_bbx_gt_woDistractor.txt', help='Training dataset directory')
...
state_dict = torch.load('weights/backup/PPLCNET0.25_Final.pth')
...
def train():
   ...
   dataset = ufddface( training_dataset)
